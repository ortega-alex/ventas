                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <form action="<?php echo base_url();?>administrador/usuarios/update" method="POST">
                            <input type="hidden" value="<?php echo $usuarios->usuario;?>" name="usuario">
                            <div class="form-group">
                                <div class="col-xs-12 col-md-6 col-lg-6 <?php echo form_error('nombre') != false ? 'has-error':'';?>"> 
                                    <label for="nombre" class="control-label" style="text-align: left;">Nombre:</label>
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input name="nombre"  class="form-control input-md" id="nombre" value="<?php echo form_error('nombre') != false ? set_select('nombre'):$usuarios->nombre;?>">
                                    </div>
                                ...
                                <div class="col-xs-12 col-md-6 col-lg-6"> 
                                    ...
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input name="apellido"  class="form-control input-md" id="apellido" value="<?php echo $usuarios->apellido;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12 col-md-6 col-lg-6"> 
                                    ...
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input name="telefono"  class="form-control input-md" id="telefono" value="<?php echo $usuarios->telefono;?>">
                                    </div> 
                                </div>
                                <div class="col-xs-12 col-md-6 col-lg-6 <?php echo form_error('email') != false ? 'has-error': '';?>"> 
                                    <label for="email" class="control-label" style="text-align: left;">Email:</label>
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input name="email"  class="form-control input-md" id="apellido" value="<?php echo form_error('email') != false ? set_select('email'):$usuarios->email;?>">
                                    </div>                                        
                                    <?php echo form_error("email","<span clas='help-block'>","</span>"); ?>
                                </div>
                            </div>
                            <div class="fom-group">
                                <div class="col-xs-12 col-md-4 col-lg-4 <?php echo form_error('user') != false ? 'has-error': '';?>"> 
                                    <label for="user" class="control-label" style="text-align: left;">User:</label>
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input type="text" name="user"  class="form-control input-md" id="user" value="<?php echo form_error('user') != false ? set_select('user'):$usuarios->username;?>">
                                    </div>                                        
                                    <?php echo form_error("user","<span clas='help-block'>","</span>"); ?>
                                </div>
                                <div class="col-xs-12 col-md-4 col-lg-4 <?php echo form_error('pass') != false ? 'has-error': '';?>"> 
                                    <label for="pass" class="control-label" style="text-align: left;">Password:</label>
                                    <div class="input-group col-xs-12 col-md-12">
                                        <input type="password" name="pass"  class="form-control input-md" id="pass" value="<?php echo form_error('pass') != false ? set_select('pass'):$usuarios->password;?>">
                                    </div>                                        
                                    <?php echo form_error("pass","<span clas='help-block'>","</span>"); ?>
                                </div>                    
                                
                                <div class="col-xs-12 col-md-4 col-lg-4 <?php echo form_error('rol') != false ? 'has-error':'';?>"> 
